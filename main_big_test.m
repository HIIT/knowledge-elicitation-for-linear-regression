...
% and P_gamma_gt leaned by using all the data (ground truth).
...
num_trainingdata   = 30;                   %training data

% define z_star_gt in a meaningful way (either by ground truth or expert opinion)
...
save('results', 'Loss_1', 'Loss_2', 'Loss_3', 'Loss_4', 'decisions', 'model_params', ...
    'z_star_gt', 'Method_list',  'num_features','num_trainingdata', 'MODE', 'normalization_method')
evaluate_results
